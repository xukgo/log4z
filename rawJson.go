...
func (r RawJSONString) MarshalLogObject(enc zapcore.ObjectEncoder) error {
...
func RawJSONField(key string, val string) zap.Field {
	return zap.Field{Key: key, Type: zapcore.ObjectMarshalerType, Interface: RawJSONString(val)}
}
